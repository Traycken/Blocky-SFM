...
END"""
    ...
    script = f"""() => {{
        ...
        const s = heuristicParseSFM(code);
    ...
    if blocks_count != 1 or trigger_kids != 2:
        raise Exception(f"Heuristic parse failed! Blocks: {blocks_count}, Trigger kids: {trigger_kids}")

    page.screenshot(path="verification_heuristic_v2.png")
